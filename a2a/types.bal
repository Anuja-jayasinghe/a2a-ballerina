...
public type ListTaskPushNotificationConfigsResult record {|
    # The matching push-notification configs for this page
...
public type ApiKeySecurityScheme record {|
    # Human-readable description of this scheme
    string? description?;
    # Where the API key is sent
    "query"|"header"|"cookie" 'in;
    # The header, query, or cookie parameter name
    string name;
    # Discriminator identifying this as an API-key scheme
    "apiKey" 'type = "apiKey";
    json...;
|};
...
public type HttpAuthSecurityScheme record {|
    ...
    string? bearerFormat?;
    # Discriminator identifying this as an HTTP-auth scheme
    "http" 'type = "http";
    json...;
|};
...
public type OAuth2SecurityScheme record {|
    ...
    # Discriminator identifying this as an OAuth2 scheme
    "oauth2" 'type = "oauth2";
    json...;
|};
...
public type OpenIdConnectSecurityScheme record {|
    ...
    # Discriminator identifying this as an OpenID Connect scheme
...
public type MutualTlsSecurityScheme record {|
    # Human-readable description of this scheme
    string? description?;
    # Discriminator identifying this as a mutual-TLS scheme
