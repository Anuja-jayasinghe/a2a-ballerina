...
public isolated client class JsonRpcClient {
    *ClientMethods;
    ...
    # + return - the unwrapped result; a typed Error for a JSON-RPC-level
    ...
    # through a remote method on self, which the codebase avoids
    # elsewhere too - every other cross-call here goes through a private
    # helper, not self->.
    #
